...
let routes = [
  {
    ...
    children: [
      ...
      {path: '/table', component: Table, name: '用户总览', class: 'fa-table'},
      {path: '/form', component: Form, name: '订单总览', class: 'fa-newspaper-o'},
      {path: '/editor', component: ue, name: '车票总览', class: 'fa-plug'},
      {path: '/list', component: List, name: '列车总览', class: 'fa-plug'}
    ]
  }
];
